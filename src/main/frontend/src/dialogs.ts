...
// AJS and AJS.dialog2 are provided by Confluence AUI at runtime
declare const AJS: {
  dialog2(selector: string): { show(): void; hide(): void; remove(): void };
  flag(options: { type: string; title: string; body: string; close?: string }): void;
};
