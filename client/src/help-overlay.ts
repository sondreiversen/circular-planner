...
const SHORTCUTS: { key: string; action: string }[] = [
  ...
  { key: 'Ctrl/Cmd + C',  action: 'Copy selected activity' },
  { key: 'Ctrl/Cmd + V',  action: 'Paste activity (date-shifted to today)' },
  ...
  { key: 'Home',          action: 'Jump to planner start date' },
  { key: 'End',           action: 'Jump to planner end date' },
  { key: '1',             action: 'Switch to disc view' },
  { key: '2',             action: 'Switch to list view' },
  { key: '3',             action: 'Switch to people view' },
  { key: '/',             action: 'Focus search (expands sidebar if collapsed)' },
  { key: 'Esc',           action: 'Clear search (when search is focused); otherwise close dialog / overlay' },
];
